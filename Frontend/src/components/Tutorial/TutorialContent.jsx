...
const TutorialContent = () => {
    return (
        <div className="min-h-screen w-full bg-gray-900 pt-24 pb-24 z-[1]">
            <div className="max-w-3xl mx-auto bg-gray-900 rounded-lg shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] p-8 z-40">
